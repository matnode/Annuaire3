...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('Contactapps_contact', 'photo',
                      self.gf('django.db.models.fields.files.ImageField')(default=datetime.datetime(2015, 8, 3, 0, 0), max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contact.photo'
        db.delete_column('Contactapps_contact', 'photo')
